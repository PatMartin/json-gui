...
public class JsonGuiPane extends MigPane
{
  ...
  /**
   * 
   * Convenience function to retrieve a string value from a map.  If
   * not found, provide the default value instead.
   * 
   * @param map The map to extract the value from.
   * @param key The key of the value to extract.
   * @param defaultValue The default value when not found.
   * 
   * @return The string value if found within the map, otherwise the
   * default value.
   * 
   */
  ...
  /**
   * 
   * Convenience function to retrieve a boolean value from a map.  If
   * not found, provide the default value instead.
   * 
   * @param map The map to extract the value from.
   * @param key The key of the value to extract.
   * @param defaultValue The default value when not found.
   * 
   * @return The boolean value if found within the map, otherwise the
   * default value.
   * 
   */
  ...
  /**
   * 
   * Convenience function to retrieve a int value from a map.  If
   * not found, provide the default value instead.
   * 
   * @param map The map to extract the value from.
   * @param key The key of the value to extract.
   * @param defaultValue The default value when not found.
   * 
   * @return The int value if found within the map, otherwise the
   * default value.
   * 
   */
  ...
  /**
   * 
   * Convenience function to retrieve a double value from a map.  If
   * not found, provide the default value instead.
   * 
   * @param map The map to extract the value from.
   * @param key The key of the value to extract.
   * @param defaultValue The default value when not found.
   * 
   * @return The double value if found within the map, otherwise the
   * default value.
   * 
   */
